import type { Attack } from "./StarterManual.ts";
import type { Manual } from "./StarterManual.ts";
...

{
    ...
    grade: 'Earth',
    statRequirements: { constitution: 14 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 16 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 18 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 20 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 22 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 24 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { constitution: 28 },
    attacks: [
  ...
  },
  {
    ...
    attacks: [
      ...
      { name: 'Mantle Burst',       dmg: 2.8, staminaCost: 16, qiCost: 0.52, chance: 0.05, t: 'physical' }
    ],
    weight: 0.63
  },
  {
...

  {
    ...
    grade: 'Earth',
    statRequirements: { charisma: 14 },
    attacks: [
      { name: 'Radiant Whisper',  dmg: 0.68, staminaCost: 5,  qiCost: 0.20, chance: 0.75, t: 'spiritual' },
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { charisma: 16, constitution: 18 },
    attacks: [
      ...
      { name: 'Crescendo Roar',  dmg: 3.50, staminaCost: 18, qiCost: 0.55, chance: 0.05, t: 'physical' }
    ],
    weight: 0.62
  },
  {
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { charisma: 18, qiAffinity: 10 },
    attacks: [
      ...
      { name: 'Carnival Cataclysm', dmg: 3.9, staminaCost: 18, qiCost: 0.55, chance: 0.05, t: 'spiritual' }
    ],
    weight: 0.56
  },
  {
  ...
  },
  {
    ...
    methodStats: { charisma: 1.90, luck: 1.0},
    methodDescription: 'Oration echoes across realms. Charisma × 1.90 + Luck: 1.0',
    grade: 'Earth',
    statRequirements: { charisma: 22, luck: 12},
    attacks: [
  ...
  //intelligence manuals
  {
    ...
    grade: 'Earth',
    statRequirements: { intelligence: 15 },
    attacks: [
    ...
    grade: 'Earth',
    statRequirements: { intelligence: 18 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { intelligence: 1.8, constitution: 0.6 },
    methodDescription: 'Logic stands unbroken by doubt. Intelligence × 1.80 + Constitution x 0.6',
    grade: 'Earth',
    statRequirements: { intelligence: 18, constitution: 14 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { intelligence: 1.90, constitution: 0.4 },
    methodDescription: 'Primal truths flow like rivers. Intelligence × 1.90',
    grade: 'Earth',
    statRequirements: { intelligence: 16, constitution: 12 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { intelligence: 1.75, qiAffinity: 0.5 },
    methodDescription: 'Runes hum in perfect harmony. Intelligence × 1.75 + Qi Affinity x 0.5',
    grade: 'Earth',
    statRequirements: { intelligence: 17 , qiAffinity: 14 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { intelligence: 22 },
    attacks: [
  ...
  {
    title: 'Wrathful Equation Recital',
    equipped: false,
  ...
  },
  {
    ...
    methodStats: { intelligence: 1.82, qiAffinity: 1.2 },
    methodDescription: 'Magma flows write destinies. Intelligence × 1.82 + Qi Affinity x 1.2',
    grade: 'Earth',
    statRequirements: { intelligence: 24, qiAffinity: 20 },
    attacks: [
  ...
  },
  {
    ...
    grade: 'Earth',
    statRequirements: { intelligence: 26 },
    attacks: [
  ...
  },
  {
    ...
    equipped: false,
    description: 'Trace magma currents to understand raw elemental patterns.',
    methodStats: { intelligence: 2.0, strength: 1.2 },
    methodDescription: 'Magma flows write destinies. Intelligence × 2.0 + Strength x 1.2',
    grade: 'Earth',
    statRequirements: { intelligence: 1.82, strength: 20 },
    attacks: [
      { name: 'Magma Breath Jab',         dmg: 1.00, staminaCost: 8,  qiCost: 0.26, chance: 0.75, t: 'spiritual' },
      { name: 'Eruption Insight Wave',    dmg: 2.15, staminaCost: 16, qiCost: 0.51, chance: 0.20, t: 'spiritual' },
      { name: 'Volcanic Revelatory Cataclysm', dmg: 3.20, staminaCost: 18, qiCost: 0.55, chance: 0.05, t: 'spiritual' }
  ...
  {
    title: 'Holy Flower Perception',
    equipped: false,
    description: 'Compute waveforms to harness vibrational power.',
    methodStats: { intelligence: 1.85, strength: 0.8, qiAffinity: 1.2},
    methodDescription: 'Waves resonate my inner pride. Intelligence × 1.92 + Strength x 0.8 + Affinity x 1.2',
    grade: 'Earth',
    statRequirements: { intelligence: 20, strength: 15, qiAffinity: 12},
    attacks: [
      { name: 'Waveform Jab',             dmg: 1.05, staminaCost: 8,  qiCost: 0.27, chance: 0.75, t: 'spiritual' },
      { name: 'Vibration Surge',           dmg: 2.30, staminaCost: 17, qiCost: 0.52, chance: 0.20, t: 'spiritual' },
      { name: 'Calculus Cataclysm',        dmg: 3.20, staminaCost: 18, qiCost: 0.55, chance: 0.05, t: 'spiritual' }
  ...
  },
  {
    ...
    methodStats: { dexterity: 1.70, constitution: 1.2 },
    methodDescription: 'Pebbles guide each elegant spin. Dexterity × 1.70 + Constitution x 1.2',
    grade: 'Earth',
    statRequirements: { dexterity: 20 , constitution: 14 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { dexterity: 1.95, strength: 1.2 },
    methodDescription: 'Winds cradle each agile drift. Dexterity × 1.95',
    grade: 'Earth',
    statRequirements: { dexterity: 19 , strength: 16 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { dexterity: 2.00, constitution: 0.4 },
    methodDescription: 'Pebbles guide precise leaps. Dexterity × 2.00 + Constitution x 0.4',
    grade: 'Earth',
    statRequirements: { dexterity: 2.00, constitution: 0.4 },
    attacks: [
  ...
  },
  {
    ...
    methodStats: { dexterity: 2.0, intelligence: 1.6 },
    methodDescription: 'Dust whirls under each vortex. Dexterity × 1.78 + Intelligence x 1.6',
    grade: 'Earth',
    statRequirements: { dexterity: 20, intelligence: 18 },
    attacks: [
